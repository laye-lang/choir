#ifndef CHOIR_CORE_RTTI_HH
#define CHOIR_CORE_RTTI_HH
...
auto cast_impl(Value&& value) {
    ...
    /// of From is-a To, perform the cast, otherwise, return null.
        ...
        CHOIR_ASSERT(value, "Cannot perform dynamic cast from null");
        ...
        if constexpr (checked) CHOIR_ASSERT(false, "Unexpected dynamic type");
