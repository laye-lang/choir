...
public sealed class ChoirBuilder(ChoirModule module)
{
    ...
    public ChoirValue BuildAdd(Location location, string name, ChoirTypeLoc type, ChoirValue left, ChoirValue right)
    {
        ...
        return Insert(new ChoirInstAdd(location, name, type, left, right));
    }
