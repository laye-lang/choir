...
public sealed record class OldModuleImport(SyntaxDeclImport ImportDecl, OldModule ReferencedModule);

public sealed class OldModule(SourceFile sourceFile)
{
    private readonly List<SyntaxToken> _tokens = [];
    private readonly List<SyntaxNode> _topLevelSyntax = [];
    private readonly List<OldModuleImport> _imports = [];
    ...
    public void AddImportReference(SyntaxDeclImport importDecl, OldModule referencedModule) => _imports.Add(new(importDecl, referencedModule));
